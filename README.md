...
- [Copia o arquivo de dependências e instala](#copia-o-arquivo-de-dependências-e-instala)
- [Copia todo o código da aplicação](#copia-todo-o-código-da-aplicação)
- [Define o ponto de entrada da aplicação](#define-o-ponto-de-entrada-da-aplicação)
